 ...
 */
final class Version20230605113057 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE comment (id INT AUTO_INCREMENT NOT NULL, video_id INT DEFAULT NULL, text VARCHAR(255) NOT NULL, upload_date DATETIME NOT NULL, is_deleted TINYINT(1) NOT NULL, INDEX IDX_9474526C29C1004E (video_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, comment_id INT DEFAULT NULL, login VARCHAR(32) NOT NULL, password VARCHAR(255) NOT NULL, email VARCHAR(32) NOT NULL, is_active TINYINT(1) NOT NULL, is_deleted TINYINT(1) NOT NULL, activation_token VARCHAR(255) DEFAULT NULL, session_token VARCHAR(255) DEFAULT NULL, session_token_expire_date DATETIME DEFAULT NULL, INDEX IDX_8D93D649F8697D13 (comment_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
